...
/**
 * Job: filter_job Purpose: filter output<br>
 * Description:  <br>
 * @author adam.mccloskey@onwelo.com
 * @version 8.0.1.20231017_1026-patch
 * @status 
 */
public class filter_job implements TalendJob {
	static {System.setProperty("TalendJob.log", "filter_job.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(filter_job.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "filter_job";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_IMBp8BN_Ee-8aP9N_HLuHg", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(filter_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_TEST_filter_job = new byte[0];
    static byte[] commonByteArray_TEST_filter_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_filter_job.length) {
				if(length < 1024 && commonByteArray_TEST_filter_job.length == 0) {
   					commonByteArray_TEST_filter_job = new byte[1024];
				} else {
   					commonByteArray_TEST_filter_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_filter_job, 0, length);
			strReturn = new String(commonByteArray_TEST_filter_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TEST_filter_job, 0, length);
			strReturn = new String(commonByteArray_TEST_filter_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_filter_job) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "XZNLrc_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_1{
                    ...
                    log4jParamters_tFileOutputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
                            log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file1.csv\"");
                        log4jParamters_tFileOutputDelimited_1.append(" | ");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file1.csv")).getAbsolutePath().replace("\\","/");
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "\"C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/rejects_file1.csv\"");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/rejects_file1.csv")).getAbsolutePath().replace("\\","/");
                ...
                class BytesLimit65535_tFilterRow_1{
                    ...
                    log4jParamters_tFilterRow_1.append("Parameters:");
                        ...
                        log4jParamters_tFilterRow_1.append(" | ");
                            log4jParamters_tFilterRow_1.append("CONDITIONS" + " = " + "[{OPERATOR="+("==")+", RVALUE="+("10")+", INPUT_COLUMN="+("sales_rating")+", FUNCTION="+("")+"}]");
                        log4jParamters_tFilterRow_1.append(" | ");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("product_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("product_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("sales_rating")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("total_expenditure")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file.csv", "ISO-8859-15",";","\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.total_expenditure = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"total_expenditure", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.total_expenditure = null;
...
if(row1 != null) { 
	...
	currentComponent="tFilterRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileInputDelimited_1","input_file","tFileInputDelimited","tFilterRow_1","tFilterRow_1","tFilterRow"
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((row1.sales_rating == null? false : row1.sales_rating.compareTo(ParserUtils.parseTo_Integer(String.valueOf(10))) == 0)
                           , "sales_rating.compareTo(10) == 0 failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.sales_rating = row1.sales_rating;
               row2.total_expenditure = row1.total_expenditure;
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row3 == null){
              row3 = new row3Struct();
                ...
                row3.sales_rating = row1.sales_rating;
                row3.total_expenditure = row1.total_expenditure;
	            row3.errorMessage = ope_tFilterRow_1.getErrorMsg();
					log.debug("tFilterRow_1 - Process the record " + (nb_line_tFilterRow_1+1) + ".");
					
					log.debug("tFilterRow_1 - Reject the record " + (nb_line_tFilterRow_1+1) + ". Caused by: " + row3.errorMessage+ ".");
...
if(row2 != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tFilterRow_1","tFilterRow_1","tFilterRow","tFileOutputDelimited_1","output_file","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row2.sales_rating != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.sales_rating
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row2.total_expenditure != null) {
                        sb_tFileOutputDelimited_1.append(
                            row2.total_expenditure
                        );
                            }
...
if(row3 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tFilterRow_1","tFilterRow_1","tFilterRow","tFileOutputDelimited_2","rejects_file","tFileOutputDelimited"
    			...
    			if(log.isTraceEnabled()){
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.sales_rating != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.sales_rating
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.total_expenditure != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.total_expenditure
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
			...
			cLabel="input_file";
                ...
                if(!((Object)("C:/Users/adam.mccloskey/OneDrive - ONWELO S.A/Pulpit/GE_talemd/output_data/output_file.csv") instanceof java.io.InputStream)){
    ...
    globalMap.put("tFilterRow_1_NB_LINE_REJECT", nb_line_reject_tFilterRow_1);
    	...
    	log.info("tFilterRow_1 - Processed records count:" + nb_line_tFilterRow_1 + ". Matched records count:" + nb_line_ok_tFilterRow_1 + ". Rejected records count:" + nb_line_reject_tFilterRow_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tFileInputDelimited_1","input_file","tFileInputDelimited","tFilterRow_1","tFilterRow_1","tFilterRow","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tFilterRow_1","tFilterRow_1","tFilterRow","tFileOutputDelimited_1","output_file","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_2", true);
				...
				log.debug("tFileOutputDelimited_2 - Written records count: " + nb_line_tFileOutputDelimited_2 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tFilterRow_1","tFilterRow_1","tFilterRow","tFileOutputDelimited_2","rejects_file","tFileOutputDelimited","reject")) {
						talendJobLogProcess(globalMap);
					}
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "5yr91c_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        final filter_job filter_jobClass = new filter_job();

        int exitCode = filter_jobClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'filter_job' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'filter_job' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_IMBp8BN_Ee-8aP9N_HLuHg");
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-05-16T13:16:58.042168300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = filter_job.class.getClassLoader().getResourceAsStream("test/filter_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = filter_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'filter_job' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : filter_job");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'filter_job' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     124545 characters generated by Talend Cloud Data Management Platform 
 *     on the 16 maja 2024 15:16:58 CEST
 ************************************************************************************************/