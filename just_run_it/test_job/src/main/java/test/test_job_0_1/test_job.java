...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "Wm2pRN_" + subJobPidCounter.getAndIncrement());
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "/home/data/input/input_file.csv");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/home/data/input/input_file.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/home/data/input/input_file.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
			...
			cLabel="input_file";
                ...
                if(!((Object)("/home/data/input/input_file.csv") instanceof java.io.InputStream)){
...
public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "wdX1VU_" + subJobPidCounter.getAndIncrement());
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_2{
                    ...
                    log4jParamters_tFileInputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                            log4jParamters_tFileInputDelimited_2.append("FILENAME" + " = " + "/home/data/input/lookup_data.csv");
                        log4jParamters_tFileInputDelimited_2.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "/home/data/input/lookup_data.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("/home/data/input/lookup_data.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
			...
			cLabel="lookup_file";
                ...
                if(!((Object)("/home/data/input/lookup_data.csv") instanceof java.io.InputStream)){
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "thiLZV_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'test_job' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-05-13T14:24:18.199594300Z");
 ...
 *     on the 13 maja 2024 16:24:18 CEST
 ************************************************************************************************/